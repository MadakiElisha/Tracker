...
class ArduPilotBackend(FCBackend):
    ...
    def arm_and_takeoff(self, altitude_m: float) -> bool:
        ...
        # Command raw arming sequence (Using safe mavutil namespace constants)
    ...
    def _execute_velocity(self, vx: float, vy: float, vz: float, yaw_rate: float):
        ...
        self.master.mav.set_position_target_local_ned_send(
            ...
            self.target_system, self.target_component,
            mavutil.mavlink.MAV_FRAME_BODY_NED, # Frame relative to current heading (Body-fixed NED namespace fix)
            type_mask,
